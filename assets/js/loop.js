jQuery( function($){
	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/slider1.png', title : '<div class="hero-text"><h2 class="hero-heading"> MADISON NOTEWORTHY </h2><p> Inspiration through Innovation </p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider1.png', title : '<div class="hero-text"><h2 class="hero-heading"> BECOME INSPIRED </h2><p> Watch. Learn. Become Inspired! </p></div>', thumb : '', url : ''},
	...
	*/
	...
	twitterFetcher.fetch( '575892635925135360', 'tweet', 1, true, false, true, 'default');
